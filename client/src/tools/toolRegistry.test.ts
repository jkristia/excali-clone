...
describe('ToolRegistry', () => {
    ...
    it('line tool defaultStyle forces both caps to none', () => {
        const registry = new ToolRegistry(new ShapeRegistry());
        const style = { stroke: '#000', fill: '#fff', strokeWidth: 2, strokeStyle: 'solid', fillStyle: 'solid', sloppiness: 'plain', opacity: 1, fontSize: 18, fontFamily: Font.Font1, hAlign: 'left', vAlign: 'middle', noteFill: '#fff', startCap: 'arrow', endCap: 'arrow', edges: 'sharp' } as const;
    ...
    it('arrow tool defaultStyle forces start none / end arrow', () => {
        const registry = new ToolRegistry(new ShapeRegistry());
        const style = { stroke: '#000', fill: '#fff', strokeWidth: 2, strokeStyle: 'solid', fillStyle: 'solid', sloppiness: 'plain', opacity: 1, fontSize: 18, fontFamily: Font.Font1, hAlign: 'left', vAlign: 'middle', noteFill: '#fff', startCap: 'arrow', endCap: 'none', edges: 'sharp' } as const;
