...
describe('ToolRegistry', () => {
    ...
    it('line tool defaultStyle forces both caps to none', () => {
        const registry = new ToolRegistry(new ShapeRegistry());
        const style = { stroke: '#000', fill: '#fff', strokeWidth: 2, strokeStyle: 'solid', fillStyle: 'solid', opacity: 1, fontSize: 20, labelFontSize: 16, labelHAlign: 'center', labelVAlign: 'middle', textAlign: 'left', noteFill: '#fff', startCap: 'arrow', endCap: 'arrow', edges: 'sharp' } as const;
    ...
    it('arrow tool defaultStyle forces start none / end arrow', () => {
        const registry = new ToolRegistry(new ShapeRegistry());
        const style = { stroke: '#000', fill: '#fff', strokeWidth: 2, strokeStyle: 'solid', fillStyle: 'solid', opacity: 1, fontSize: 20, labelFontSize: 16, labelHAlign: 'center', labelVAlign: 'middle', textAlign: 'left', noteFill: '#fff', startCap: 'arrow', endCap: 'none', edges: 'sharp' } as const;
